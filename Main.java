...
public class Main {
        ...
        do {
            switch (animalChoiceMenu(keyboard)) {
                ...
                case 4:
                    ...
                    System.out.println("All the object are written");
                    break;
                /**
                ...
                case 5:
                    readObjectsFromFile();
                    System.out.println("Animals read!!");
                    break;
                default:
    ...
    public static void writeObjectsToFile(Tiger tiger, Penguin penguin, Dolphin dolphin) {
        try {
            FileOutputStream tigerfos = new FileOutputStream("tiger.txt");
            FileOutputStream penguinfos = new FileOutputStream("penguin.txt");
            FileOutputStream dolphinfos = new FileOutputStream("dolphin.txt");

            ObjectOutputStream tigeroos = new ObjectOutputStream(tigerfos);
            ObjectOutputStream penguinoos =  new ObjectOutputStream(penguinfos);
            ObjectOutputStream dolphinoos = new ObjectOutputStream(dolphinfos);

            tigeroos.writeObject(tiger);
            penguinoos.writeObject(penguin);
            dolphinoos.writeObject(dolphin);
    ...
    public static void readObjectsFromFile() {
        try {
            FileInputStream tigerfos = new FileInputStream("tiger.txt");
            FileInputStream penfos =  new FileInputStream("penguin.txt");
            FileInputStream dolfos = new FileInputStream("dolphin.txt");

            ObjectInputStream tigeroos = new ObjectInputStream(tigerfos);
            ObjectInputStream penoos = new ObjectInputStream(penfos);
            ObjectInputStream dolood = new ObjectInputStream(dolfos);

            Tiger tiger = (Tiger) tigeroos.readObject();
            System.out.println(tiger);
            Penguin pen = (Penguin) penoos.readObject();
            System.out.println(pen);
            Dolphin dolphin = (Dolphin) dolood.readObject();
